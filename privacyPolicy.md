# 外集卡路径引导App 隐私政策（Privacy policy）
> 生效时间：2022-11-04        
> 最后更新时间：2022-11-08        
> 有效时间：长期有效
...
如上表所述，如果您已向我们提供了您的联系方式，我们可能会与您联系。例如，如果您向我们提供了您的电子邮箱地址，我们可能会向您发送促销电子邮件，或就您使用相关服务事宜向您发送电子邮件。此外，在您打开我们发送的电子邮件时，我们可能会收到确认 信息，这将有助于我们改善我们的服务。如果您不想收到我们与营销有关的电子邮件，您可以通过每一封此类电子邮件中的退订链接进行操作，或通过向我们发送电子邮件到 17631654092@163.com 来表明您的偏好。请注意，如果您选择拒收我们与营销相关的电 子邮件，我们仍然可能会向您发送重要的管理消息，您无法选择拒收此类消息。
...
- 为了保障软件与服务的安全运行，防止您的个人信息被非法获取，我们会收集您的设备信息【包括：设备型号、设备名称、SIM卡序列号、设备唯一标识符（包括：IMEI、IMSI、AndroidID等）】、传感器、操作系统和应用程序版本、产品版本号以及软件使用记录信息等，请您理解。
...
- 进行调试，以识别并修复损害现有预期功能的错误。
- 短期、临时使用其他方未使用的个人数据，以建立消费者档案，或以其他方式在当 前互动以外改变您的客户体验。
- 代表我们提供服务，包括进行账户维护或服务、提供客户服务、处理或完成订单和 交易、核实客户信息、处理付款、提供融资、代表我们提供营销服务、提供分析服务，或代表企业或服务提供商提供类似服务。
- 为技术开发和演示进行内部研究。
- 为验证或维持我们拥有的、生产的、为我们生产的或由我们控制的服务或设备的质量或安全，进行有关活动。
...
如果你在使用外集卡路径引导APP中需要将账号注销，进入“我的”页面，点击“注销”按钮提交申请，即可完成账号的注销，注销后用户退出登录。
